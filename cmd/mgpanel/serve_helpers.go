...
func buildBinaryVersionProvider() service.BinaryVersionRemoteProvider {
	repos := map[string]string{
		service.BinaryVersionComponentAgent:   envOrDefault("MGPANEL_VERSION_REPO_AGENT", "creamcroissant/mgpanel"),
		service.BinaryVersionComponentSingBox: envOrDefault("MGPANEL_VERSION_REPO_SING_BOX", "SagerNet/sing-box"),
		service.BinaryVersionComponentXray:    envOrDefault("MGPANEL_VERSION_REPO_XRAY", "XTLS/Xray-core"),
	}
