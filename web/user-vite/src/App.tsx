...
const AdminRouting = lazy(() => import("@/pages/admin/routing"));
const AdminDns = lazy(() => import("@/pages/admin/dns"));
const AdminCoreSettings = lazy(() => import("@/pages/admin/core-settings"));
  ...
  return (
    <Routes>
      ...
      <Route element={<RequireAdminAuth />}>
        ...
        <Route path={ADMIN_ROUTES.OUTBOUND} element={<AdminOutbound />} />
        <Route path={ADMIN_ROUTES.ROUTING} element={<AdminRouting />} />
        <Route path={ADMIN_ROUTES.DNS} element={<AdminDns />} />
        <Route path={ADMIN_ROUTES.CORE_SETTINGS} element={<AdminCoreSettings />} />
      </Route>
