...
// danger 为 destructive 的兼容别名，样式单一来源
const destructiveBadge = "border border-destructive/20 bg-destructive/15 text-destructive";
...
const Badge = React.forwardRef<HTMLSpanElement, BadgeProps>(
  ({ className, variant = "default", ...props }, ref) => (
    <span
      ref={ref}
      className={cn(
        "inline-flex w-fit items-center whitespace-nowrap rounded-none px-2 py-0.5 text-xs font-medium",
